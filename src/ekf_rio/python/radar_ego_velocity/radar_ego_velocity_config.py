...
class Radar_ego_velocity_config:
    def __init__(self):
        ...
        self.min_db = 3.0 # 0 to 50
        self.azimuth_thresh_deg = 60 # 0 to 100
        self.elevation_thresh_deg = 60 # 0 to 100
        self.filter_min_z = -3 # -1000 to 1000
        self.filter_max_z = 3 # -1000 to 1000
        self.doppler_velocity_correction_factor = 1.0 #0 to 2
        self.allowed_outlier_percentage = 0.25 # 0 to 1
        self.thresh_zero_velocity = 0.05 #0 to 10
        self.sigma_zero_velocity_x = 0.025 # 0 to 10
        self.sigma_zero_velocity_y = 0.025 # 0 to 10
        self.sigma_zero_velocity_z = 0.025 # 0 to 10
        ...
        self.sigma_offset_radar_x = 0.05 # 0 to 10
        self.sigma_offset_radar_y = 0.025 # 0 to 10
        self.sigma_offset_radar_z = 0.05 # 0 to 10
        self.max_sigma_x = 0.2 # 0 to 10
        self.max_sigma_y = 0.2 # 0 to 10
        self.max_sigma_z = 0.2 # 0 to 10
        self.sigma_v_d = 0.125 # 0 to 10
        self.model_noise_offset_deg = 2.0 # 0 to 100
        self.model_noise_scale_deg = 10.0 # 0 to 100