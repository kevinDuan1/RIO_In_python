      ...
      public:
            ...
            public:
                  ParamDescription(std::string a_name, std::string a_type, uint32_t a_level,
                                   std::string a_description, std::string a_edit_method, T RadarEgoVelocityEstimatorConfig::*a_f) : AbstractParamDescription(a_name, a_type, a_level, a_description, a_edit_method),
                                                                                                                                    field(a_f)
                  {
                  }
                  ...
                  public:
                        ...
                        void setParams(RadarEgoVelocityEstimatorConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
                        {
                              for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator _i = params.begin(); _i != params.end(); ++_i)
                              {
                                    ...
                                    if ("min_dist" == (*_i)->name)
                                    {
                                          min_dist = boost::any_cast<double>(val);
                                    }
                                    if ("max_dist" == (*_i)->name)
                                    {
                                          max_dist = boost::any_cast<double>(val);
                                    }
                                    if ("min_db" == (*_i)->name)
                                    {
                                          min_db = boost::any_cast<double>(val);
                                    }
                                    if ("elevation_thresh_deg" == (*_i)->name)
                                    {
                                          elevation_thresh_deg = boost::any_cast<double>(val);
                                    }
                                    if ("azimuth_thresh_deg" == (*_i)->name)
                                    {
                                          azimuth_thresh_deg = boost::any_cast<double>(val);
                                    }
                                    if ("filter_min_z" == (*_i)->name)
                                    {
                                          filter_min_z = boost::any_cast<double>(val);
                                    }
                                    if ("filter_max_z" == (*_i)->name)
                                    {
                                          filter_max_z = boost::any_cast<double>(val);
                                    }
                                    if ("doppler_velocity_correction_factor" == (*_i)->name)
                                    {
                                          doppler_velocity_correction_factor = boost::any_cast<double>(val);
                                    }
                                    if ("thresh_zero_velocity" == (*_i)->name)
                                    {
                                          thresh_zero_velocity = boost::any_cast<double>(val);
                                    }
                                    if ("allowed_outlier_percentage" == (*_i)->name)
                                    {
                                          allowed_outlier_percentage = boost::any_cast<double>(val);
                                    }
                                    if ("sigma_zero_velocity_x" == (*_i)->name)
                                    {
                                          sigma_zero_velocity_x = boost::any_cast<double>(val);
                                    }
                                    if ("sigma_zero_velocity_y" == (*_i)->name)
                                    {
                                          sigma_zero_velocity_y = boost::any_cast<double>(val);
                                    }
                                    if ("sigma_zero_velocity_z" == (*_i)->name)
                                    {
                                          sigma_zero_velocity_z = boost::any_cast<double>(val);
                                    }
                                    if ("sigma_offset_radar_x" == (*_i)->name)
                                    {
                                          sigma_offset_radar_x = boost::any_cast<double>(val);
                                    }
                                    if ("sigma_offset_radar_y" == (*_i)->name)
                                    {
                                          sigma_offset_radar_y = boost::any_cast<double>(val);
                                    }
                                    if ("sigma_offset_radar_z" == (*_i)->name)
                                    {
                                          sigma_offset_radar_z = boost::any_cast<double>(val);
                                    }
                                    if ("max_sigma_x" == (*_i)->name)
                                    {
                                          max_sigma_x = boost::any_cast<double>(val);
                                    }
                                    if ("max_sigma_y" == (*_i)->name)
                                    {
                                          max_sigma_y = boost::any_cast<double>(val);
                                    }
                                    if ("max_sigma_z" == (*_i)->name)
                                    {
                                          max_sigma_z = boost::any_cast<double>(val);
                                    }
                                    if ("max_r_cond" == (*_i)->name)
                                    {
                                          max_r_cond = boost::any_cast<double>(val);
                                    }
                                    if ("use_cholesky_instead_of_bdcsvd" == (*_i)->name)
                                    {
                                          use_cholesky_instead_of_bdcsvd = boost::any_cast<bool>(val);
                                    }
                                    if ("use_ransac" == (*_i)->name)
                                    {
                                          use_ransac = boost::any_cast<bool>(val);
                                    }
                                    if ("outlier_prob" == (*_i)->name)
                                    {
                                          outlier_prob = boost::any_cast<double>(val);
                                    }
                                    if ("success_prob" == (*_i)->name)
                                    {
                                          success_prob = boost::any_cast<double>(val);
                                    }
                                    if ("N_ransac_points" == (*_i)->name)
                                    {
                                          N_ransac_points = boost::any_cast<int>(val);
                                    }
                                    if ("inlier_thresh" == (*_i)->name)
                                    {
                                          inlier_thresh = boost::any_cast<double>(val);
                                    }
                                    if ("use_odr" == (*_i)->name)
                                    {
                                          use_odr = boost::any_cast<bool>(val);
                                    }
                                    if ("min_speed_odr" == (*_i)->name)
                                    {
                                          min_speed_odr = boost::any_cast<double>(val);
                                    }
                                    if ("sigma_v_d" == (*_i)->name)
                                    {
                                          sigma_v_d = boost::any_cast<double>(val);
                                    }
                                    if ("model_noise_offset_deg" == (*_i)->name)
                                    {
                                          model_noise_offset_deg = boost::any_cast<double>(val);
                                    }
                                    if ("model_noise_scale_deg" == (*_i)->name)
                                    {
                                          model_noise_scale_deg = boost::any_cast<double>(val);
                                    }
                              }
                        }
